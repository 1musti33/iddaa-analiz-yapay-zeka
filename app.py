...
api_key_input = st.sidebar.text_input("API-Football Anahtarı", type="password")
...
sezon_secimi = st.sidebar.text_input("Sezon Yılı (Örn: 2023, 2024, 2025)", "2024")
...
if 'veri' in st.session_state:
    ...
    with col3:
        ...
        dep_logo_url = df[df['Deplasman'] == secilen_dep]['Dep Logo'].iloc[0]
